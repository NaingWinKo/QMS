...
Route::prefix('admin')->middleware('admin')->group(function () {
    Route::get('noti/index',[NotiController::class,'index'])->name('noti.index');
    Route::get('noti/create',[NotiController::class,'create'])->name('noti.create');
    Route::post('noti/store',[NotiController::class,'store'])->name('noti.store');
    Route::get('noti/edit/{id}',[NotiController::class,'edit'])->name('noti.edit');
    Route::put('noti/update/{id}',[NotiController::class,'update'])->name('noti.update');
    Route::delete('noti/delete/{id}',[NotiController::class,'delete'])->name('noti.delete');
    ...
    Route::get('student/{id}',[AdminController::class, 'roleEdit'])->name('edit.role');
...
Route::middleware('auth')->group(function () {
     ...
     Route::get('noti/all',[NotiController::class,'notiAll'])->name('noti.all');
