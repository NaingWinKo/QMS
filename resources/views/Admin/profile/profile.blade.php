                    ...
                    <div class="col-md-4 mb-5">
                        <div class="border hover-grow-card pt-3 mt-5 rounded shadow-lg">
                            <ul class="list-group list-group-flush p-3">
                                ...
                                <li class="list-group-item bg-transparent  text-sm"><b>အမည် :</b>&nbsp; {{ $user->name }}</li>
                                <li class="list-group-item bg-transparent text-sm"><b>Email :</b>&nbsp; {{ $user->email }}</li>
                                <li class="list-group-item bg-transparent  text-sm"><b>ရာထူး :</b>&nbsp; {{ $user->role }}</li>
                                <li class="list-group-item bg-transparent">
                                    <a href="{{route('edit.profile.admin',$user->id)}}" class="btn btn-sm btn-primary float-end  border-success"> Edit Profile</a>
                                    <a href="{{route('admin.index')}}" class="btn btn-sm btn-primary text-white border-success">Back</a>
                                </li>
                            </ul>
                        </div>
                    </div>
