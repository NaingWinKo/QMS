...
<head>
    ...
    <style>
        ...
        .profileimg{
                ...
                border-radius: 50%;
                margin: 0 auto;
                box-shadow: 3px 3px 3px rgb(5, 110, 110);
        }

       .wbtn{
        background-color: rgb(7, 67, 107);
        overflow: hidden;
       }
...
.custom-table td, .custom-table th {
    border-bottom: 1px solid #042436; /* Add bottom border to each td and th */
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav wbtn sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin.index')}}">
                ...
                <div class="sidebar-brand-text mx-3">Quiz<sup class="text-lowercase">MS</sup></div>
            </a>
            ...
            <li class="nav-item {{ request()->routeIs('noti.index') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('noti.index') }}">
                    <i class="fa-regular fa-building"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <footer class="sticky-footer" style="background: rgb(71, 69, 69);position:fixed;bottom:0px;top:auto;width:100%;color:white;">
                <div class="container mt-0">
                    <div class="copyright text-center">Copyright NWK</div>
                </div>
            </footer>
