                ...
                <div class="card mt-3">
                    <form action="{{route('store.question')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="question_text" class="text-muted"><b>Enter question</b></label>
                            ...
                            <div class="mb-3">
                                <label for="category_id" class="text-muted"><b>Choose category</b></label>
                        ...
                        <div class="card-footer border-0">
                            <a href="{{ route('questions') }}" class="btn wbtn text-white mb-3 border-success">Back</a>
