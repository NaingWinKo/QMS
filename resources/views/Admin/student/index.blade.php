                            ...
                            <form
                                ...
                                <div class="input-group mt-4">
                                    <form action="{{ route('student.list') }}">@csrf
                                        <input type="text" name="search" class="form-control   border-success small search-input"  placeholder="Enter Name...."
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 hover-grow-card">
                                <div class="border pt-3 rounded shadow-lg h-100">
                                    ...
                                    <div class="card-body text-center">
                                        <h5 class="text-sm text-black fw-bold" style="font-size: 15px;">{{ $stu->name }}</h5>
