                ...
                <div class="mr-5">
                    <form action="{{ route('login') }}" method="post"> 
                        ...
                        <div class=" p-4 border-0 " >
                            ...
                            <div class="my-2">
                                <button class="btn btn-info btn-sm wbtn border mb-3 shadow ">အကောင့်၀င်မည်</button>
                                <a href="{{ route('register') }}"><b class="btn btn-info btn-sm wbtn border mb-3 shadow float-end">အကောင့်သစ်ဖွင့်ရန်</b></a>
                                <div class="text-black">အကောင့်မရှိပါက"<b>အကောင့်သစ်ဖွင့်ရန်</b>"ကိုနှိပ်ပါ
                                </div>
                            </div>
                        </div>
                    </form>
