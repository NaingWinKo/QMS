    ...
    <style>
        ...
        .tableborder{
            ...
            <div class="page-wrapper mt-0">
                ...
                <!-- Page Content -->
                <div class="content container mt-5"style="min-height: 746px">
                    <!-- Page Header -->
                    <div class="page-header">
                        <div class="row align-items-center ">
                            <h3 class="pcolor mb-3 fontwmz mt-5"> Hello {{ Auth::user()->name }},
                                သင်ဖြေဆိုခဲ့ဖူးသော မှတ်တမ်း</h3>
                    ...
                    @if ($scores->isEmpty())
                        <div class="bg-warning">
                            <h2 class="text-center">No history was found in your account!!</h2>
                        </div>
                    @else
