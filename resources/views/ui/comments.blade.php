            ...
            <div class="container mt-5 scrollable-container ">
                ...
                <div class="row border mt-4" style="box-shadow: 0px 10px 20px -10px rgba(0, 0, 0, 0.5); padding: 50px;">
                    ...
                    <div class="col-12 col-md-8 col-lg-10 mt-5">
                        <div class=""><a href="{{route('user.posts')}}" class="btn btn-sm bg-info float-end text-white">Back</a></div>
                        <ul>
                            <i class="fas fa-user"></i> <span class="pcolor">&nbsp;&nbsp;ရေးသားသူ - <b>{{ $post->user->name }}</b>
                        ...
                        <div>
                            <div class="mt-4">
                                <p class="pcolor">မန့်ထားသောကွန့်မန့်များ </p>
