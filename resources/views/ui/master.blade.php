...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('ui-images/quiz_logo.png') }}" rel="icon">
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top p-3">
        <div class="container-fluid  container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto me-lg-0">
                ...
                <img src="{{ asset('ui-images/quiz_logo1.jpg') }}"  style="width: 100px;height:300px"
                    alt="Quiz Logo">
                    <span style="color: rgb(13, 87, 136);font-size:1.2rem" class="fw-bold">Quiz Management System
                ...
                <ul>
                    ...
                    @if (Auth::check())
                        <li><a href="{{ route('user.posts') }}" style="color:  rgb(13, 87, 136);font-size:1rem"
                                class="fw-bold">လေ့လာရန်</a></li>
                       <li><a href="{{ route('noti.all') }}" style="color:  rgb(13, 87, 136);font-size:1rem"
                                    class="fw-bold">အသိပေးချက်</a></li>
                    ...
                    @else
                        ...
                        <li><a href="{{ route('login') }}" style="color:  rgb(13, 87, 136);font-size:1rem"
                                class="fw-bold">အကောင့်ဝင်ရန်</a></li>
                    @endif
    ...
    <main class="main">
        ...
        <footer id="footer" class="mt-5" style="background-color: rgb(4, 44, 71);padding:20px;position:fixed;bottom:0px;top:auto;z-index:999999;width:100%;">
            <div class="copyright">
