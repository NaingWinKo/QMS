            ...
            <div class="row g-0 d-flex align-items-center shadow-2xl">
                <div class="col-lg-5 d-none d-lg-flex ">
                    <img src="{{asset('assets/img/login.jpg')}}"
                        alt="logo" class="w-80 ml-5 rounded-t-5 rounded-tr-lg-0 rounded-bl-lg-5" style="height: 300px" />
                </div>
                <div class="col-lg-7">
                    <div class="mr-5">
                        ...
                        <form action="{{ route('register')}}" method="post">
                            ...
                            <div class=" mt-3 p-4 border-0 " >
                                ...
                                <div class="my-2">
                                    <button class="btn btn-info btn-sm  wbtn border mb-3 shadow">အကောင့်လုပ်မည်</button>
                                    <a href="{{route('login')}}" class="btn btn-info btn-sm wbtn border mb-3 shadow float-end">အကောင့်၀င်ရန်</a></div>
                                    <div class="text-black float-center">အကောင့်ရှိပြီးသားဖြစ်ပါက"<b>အကောင့်၀င်ရန်</b>"ကိုနှိပ်ပါ </div>
                            </div>
                        </form>
                    </div>
                </div>
