        ...
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-2 content">
                ...
                <ul style="font-family: 'Bangers', cursive;color:rgb(0, 0, 0)">
                    <li class="pcolor mb-4"> Web page တစ်ခုကိုဖန်တီးတည်ဆောက်ရာမှာ Frontend ရယ် Backend
                        ရယ်ဆိုပြီးနစ်မျိုးခွဲလုပ်လေ့ရှိကြပါတယ်။ အဲ့ထဲမှာမှFrontend ဆိုတာကတော့သူ့နာမည်အတိုင်း
                        ကိုယ်တည်ဆောက်မယ့် Website ရဲ့ Front(အရှေ့ပိုင်း)ကိုပြောချင်တာပါ။ ဆိုလိုချင်တာကတော့ Website ရဲ့
                        အပေါ်ယံအခွံ Design ကိုဆိုလိုချင်တာပါ။ Website တစ်ခုကို လူတစ်ယောက်အ​နေနဲ့မြင်ကြည့်မည်ဆိုပါက
                        အရေပြား၊ အသားအရောင်၊ ဆံပင် စသည်ဖြင့် အပေါ်ယံဆန်တဲ့အလှတွေ အရာတွေကို Frontend
                        လို့ခေါ်ပြီး။ ဦးနှောက်၊ သွေးကြော စသည်ဖြင့် နောက်ကွယ်ကနေ
                        အသက်သွင်းပေးတဲ့အရာတွေကိုတော့ Backend ပိုင်းလို့ယူဆနိုင်ပါတယ်။
                    </li>
                    <li class="mb-4 pcolor">
                        
                        Frontend language အနေဖြင့်ဆိုရင်
                        <pre>
                    ...
                    <li class="mb-1  pcolor">
                        Backend language အနေဖြင့်ဆိုရင်
                        <pre>
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 mt-3">
            <div class="col-lg-6 order-2 order-lg-2 content">
                ...
                <ul style="font-family: 'Bangers', cursive;color:rgb(0, 0, 0)">
                    <li class="pcolor mb-4"> Html သည် Hyper Text markup language တစ်ခုဖြစ်ပြီး Website ရှိ အကြောင်းအရာများကို
                        ဖန်တီးရန်နှင့် တည်ဆောက်ရန် အသုံးပြုသည့် စံသတ်မှတ်ထားသော ဘာသာစကားဖြစ်သည်။
                        HTML ဆိုတာ Website တစ်ခုကို ပိုပြီးဆွဲဆောင်မှုရှိအောင် ဖန်တီးရာတွင် အသုံးပြုသည့် markup language
                        တစ်ခုဖြစ်သည်။ Web page တွေကိုဖန်တီးရာမှာ အသုံးအများဆုံး ဘာသာစကားတစ်ခုဖြစ်သည်။ HTML ဖြင့်
                    ...
                    <li class="mb-4 pcolor">
                        ...
                        ✨ CSS အသုံးပြုပြီး မိမိဖန်တီးထားသည့် web page မှာ font style အမျိုးမျိုး, color အမျိုးမျိုး,size
                    ...
                    <li class="mb-1  pcolor">
                        ...
                        Interactive ဖြစ်အောင် လုပ်ဆောင်ပေးသည့် နည်းပညာရပ်တစ်ခုလည်း ဖြစ်ပါသည်။
                    </li>
        ...
        <div class="row gy-4 mt-3">
            <div class="col-lg-6 order-2 order-lg-2 content">
                ...
                <ul style="font-family: 'Bangers', cursive;color:rgb(0, 0, 0)">
                    ...
                    <li class="mb-1  pcolor">
                        Laravel က MVC ဆိုတဲ့ design pattern ကိုအသုံးပြုထားပြီး MVC ဆိုတာက Model View Controller ကိုဆိုလိုပါတယ်။
                    </li>
        ...
        <div class="row gy-4 mt-3">
            <div class="col-lg-6 order-2 order-lg-2 content">
                ...
                <ul style="font-family: 'Bangers', cursive;color:rgb(0, 0, 0)">
                    ...
                    <li class="mb-4 pcolor">
                        ပုံမှန် သမာရိုးကျ Web app တွေမှာ controller ရဲ့ အရေးပါပုံ မသိသာ ပေမယ့် routing address တွေ များလာတဲ့ အခါမှာ controller နဲ့ model ချိတ်ဆက်တာ အရမ်းအရေးပါလာပါတယ်။ သာမာန် Web App တွေမှာ GET နဲ့ POST ကိုပဲ အဓိကသုံးပေမယ့် RESTful မှာတော့ GET , POST , PUT , DELETE ကို အသုံးပြုကြပါတယ်။ Controller အနေနဲ့ GET နဲ့ ဒီ လိပ်စာလာရင် ဒီ model ကို ခေါ်ပြီး ဒါကို လုပ်။ POST ဆိုရင်တော့ ဒါကို လုပ်ဆိုပြီး ခွဲခြမ်း စိတ်ဖြာပေးပြီး ရလာတဲ့ result တွေကို View နဲ့ ပြန်ထုတ်ပြပါတယ်။
                    </li>
                    <li class="mb-1  pcolor">
            ...
            <div class="col-lg-6 order-2 order-lg-2 content">
                ...
                <ul style="font-family: 'Bangers', cursive;color:rgb(0, 0, 0)">
                    <li class="pcolor mb-4">Framework ဆိုတာဘာလဲ?
                        ...
                        Framework ဆိုတာ က တော့ ဘာနဲ့ တူလဲဆိုရင် အသင့် ပြင်ဆင်ပြီးသား ပစ္စည်းအပြည့်အစုံ ထည့်ပေးထားတဲ့ အိမ်ကို ငှါးလိုက်တာနဲ့ တူပါတယ်။ ကိုယ်လိုအပ်မယ် ထင်တဲ့ ပစ္စည်းတွေကို အိမ်ရှင်ကအဆင်သင့် ထည့်ပေးထားတာမျိုးဖြစ်ပါတယ်။
